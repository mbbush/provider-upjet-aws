...
type BurnInDestinationSettingsInitParameters struct {
	...
	// in and DVB-Sub font settings must match.
	BackgroundOpacity *int64 `json:"backgroundOpacity,omitempty" tf:"background_opacity,omitempty"`
	...
	FontOpacity *int64 `json:"fontOpacity,omitempty" tf:"font_opacity,omitempty"`

	// in and DVB-Sub font settings must match.
	FontResolution *int64 `json:"fontResolution,omitempty" tf:"font_resolution,omitempty"`
	...
	// defined by the caption stream. All burn-in and DVB-Sub font settings must match.
	OutlineSize *int64 `json:"outlineSize,omitempty" tf:"outline_size,omitempty"`

	// in and DVB-Sub font settings must match.
	ShadowColor *string `json:"shadowColor,omitempty" tf:"shadow_color,omitempty"`

	// in and DVB-Sub font settings must match.
	ShadowOpacity *int64 `json:"shadowOpacity,omitempty" tf:"shadow_opacity,omitempty"`

	// 2 would result in a shadow offset 2 pixels to the left. All burn-in and DVB-Sub font settings must match.
	ShadowXOffset *int64 `json:"shadowXOffset,omitempty" tf:"shadow_x_offset,omitempty"`

	// 2 would result in a shadow offset 2 pixels above the text. All burn-in and DVB-Sub font settings must match.
	ShadowYOffset *int64 `json:"shadowYOffset,omitempty" tf:"shadow_y_offset,omitempty"`

	// Sub/Burn-in outputs.
	TeletextGridControl *string `json:"teletextGridControl,omitempty" tf:"teletext_grid_control,omitempty"`

	// in and DVB-Sub font settings must match.
	XPosition *int64 `json:"xPosition,omitempty" tf:"x_position,omitempty"`

	// in and DVB-Sub font settings must match.
	YPosition *int64 `json:"yPosition,omitempty" tf:"y_position,omitempty"`
}
...
type GlobalConfigurationInitParameters struct {
	...
	InitialAudioGain *int64 `json:"initialAudioGain,omitempty" tf:"initial_audio_gain,omitempty"`
...
type H265SettingsInitParameters struct {
	...
	// Set the minimum QP.
	MinQp *int64 `json:"minQp,omitempty" tf:"min_qp,omitempty"`
	...
	TileHeight *int64 `json:"tileHeight,omitempty" tf:"tile_height,omitempty"`
	...
	TileWidth *int64 `json:"tileWidth,omitempty" tf:"tile_width,omitempty"`
...
type InputLossBehaviorInitParameters struct {
	BlackFrameMsec *int64 `json:"blackFrameMsec,omitempty" tf:"black_frame_msec,omitempty"`
	...
	RepeatFrameMsec *int64 `json:"repeatFrameMsec,omitempty" tf:"repeat_frame_msec,omitempty"`
}
